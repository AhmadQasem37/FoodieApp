...
import 'package:food_delivery/pages/location_configuration.dart'; // Assuming LocationConfiguration is correctly implemented
import 'package:food_delivery/pages/product_details_page.dart';
import 'package:food_delivery/pages/custom_drawer.dart';
                              ...
                              children: [
                                ...
                                PositionedDirectional(
                                  ...
                                  child: IconButton(
                                    onPressed: () {
                                      setState(() {
                                        final selectedFoodItemIndex = food.indexOf(filteredFood[index]);
                                        filteredFood[index] = filteredFood[index].copywith(!filteredFood[index].isFavorit);
                                        food[selectedFoodItemIndex] = filteredFood[index];
                                      });
                                    },
                                    icon: Icon(
                                      filteredFood[index].isFavorit == false ? Icons.favorite_border : Icons.favorite,
                                      color: Colors.deepOrange,
                                    ),
                                  ),
                                )
...
// import 'package:food_delivery/models/category_item.dart';
// import 'package:food_delivery/models/food_item.dart';
// import 'package:food_delivery/pages/location_configuration.dart';
// import 'package:food_delivery/pages/product_details_page.dart';
// import 'package:food_delivery/pages/custom_drawer.dart';
