...
class FireStoreSend {
  ...
  Future<void> storeUser(
      String fullName, String email, UserCredential userCredential) async {
  ...
  Future<void> UpdateImage(String imgURL, String uid) async {
    await firestore.collection("Users").doc(uid).update({"imgURL": imgURL});
  }

  Future<void> addToCart(
      String imgURL, String itemName, int numberOfItems, double price) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
